 ...
 * %i, %ls, and %s are dynamic variables, please don't touch those!
/*/

std::map<std::string, std::wstring> ENGLISH = {
	{"translator",          L"Translated by <YOUR NAME>"},
	...
	{"no_themes_2",         L"Touch the download icon on the top"},
	{"no_themes_3",         L"to access the 3DSThem.es browser."},
	...
	{"search_4_themes",     L"Search for themes"},
	{"dump_current",        L"Dump current"},
	{"scan_code",           L"Scan code"},
	...
	// 3DSTHEM.ES.CPP
	{"err_conn_site",      L"Failed to connect to %s."},
	{"err_parse_resp",     L"Failed to parse response from %s."},
	{"err_dl_bgm",         L"An error has occured while downloading the BGM preview."}
};
